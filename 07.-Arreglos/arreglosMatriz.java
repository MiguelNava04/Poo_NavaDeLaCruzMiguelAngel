...
public class arreglosMatriz{
    ...
    public static void main(String[] args){
        ...
        */
        ...
        //tipo de dato   nombre  tammaño
        //int arreglo[] = new int[10]

        //vamos a recorrerlo

        //for (int i = 0; i<arreglo.legth; i++){
            ...
            //vamos a sumar las finlas del arreglo y sacar el promedio
        ...
        //vamos a realizar la operacion de suma y promedio
        for(int i = 0; i < matriz.length; i++){
