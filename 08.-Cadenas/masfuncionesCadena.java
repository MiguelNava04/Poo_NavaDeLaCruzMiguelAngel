...
public class masfuncionesCadena{
    ...
    public void masFunciones(){
        ...
        String s1 = new String("Hola porque mi tele no llega T_T");
        String s2 = "Harry potter ajedrez magico de lego";
        ...
        //probrar con ==, solo sirve para objetos no para cadenas
        ...
        //probar la igualidad ignorando mayusculas
